...
class TelegramQuizBot:
    ...
    async def _flush_activity_queue(self, application=None):
...
🎉 Let's make this group amazing together!"""
    ...
    async def send_quiz(self, chat_id: int, context: ContextTypes.DEFAULT_TYPE, auto_sent: bool = False, scheduled: bool = False, category: str | None = None) -> None:
